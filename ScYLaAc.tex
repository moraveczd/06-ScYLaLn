...
\frame{
	...
	\hline
	 ...
	 & stříbrnobílý & stříbrnobílý & stříbrnobílý & stříbrnobílý \\
...
\frame{
	...
	\begin{itemize}
		...
		\item Všechny aktinoidy jsou nestabilní prvky, nemají žádný stabilní izotop.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Kromě aktinia jsou to poměrně rozšířené prvky.
	...
	\begin{center}
		...
		Pm & \multicolumn{2}{l|}{4,5.10$^{-20}$} & Er & 3 & 5 \\\hline
		Sm & 7 & 0 & Tm & 0 & 5 \\\hline
		Eu & 2 & 1 & Yb & 3 & 1 \\\hline
		Gd & 6 & 1 & Lu & 0 & 8 \\\hline
	\end{tabular}
	\end{center}
	\begin{itemize}
		\item Aktinoidy nemají žádný stabilní izotop.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{column}{0.7\textwidth}
		\begin{itemize}
			...
			\item Na obrázku je velký krystal thortveititu nalezený v Norsku.
		\end{itemize}
	\end{column}
	\begin{column}{0.3\textwidth}
		\begin{center}
			\adjincludegraphics[width=\textwidth]{img/Thortveitite.jpg}
		\end{center}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Přídavkem kyseliny šťavelové lze získat sraženinu šťavelanu yttritého, který se zahříván rozkládá na oxid.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textit{Xenotim} tetragonální minerál obsahující převážně fosforečnan yttritý, \ce{YPO4}.\footnote[frame]{\href{http://mineraly.sci.muni.cz/fosfaty/xenotim.html}{Xenotim}}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.5\textheight]{img/Xenotim_mineralogisches_museum_bonn.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.5\textheight]{img/Xenotime_with_Rutile-08-2-78aa.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=1.05\textwidth]{img/Monazite_acid_cracking_process.png}
	\end{center}
	\begin{itemize}
		\item Kovový lanthan získáme z oxidu reakcí se salmiakem a následnou redukcí lithiem.
	\end{itemize}
	\begin{align*}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item S výjimkou promethia mají všechny lanthanidy stabilní izotopy.
		\item V přírodě nejsou nijak vzácné, nejvíce zastoupený je cer.
		...
		\item Jde o primární zdroj lanthanu a lanthanoidů.
	\end{itemize}
	\begin{columns}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.27\textheight]{img/Monazit_-_Mosambik.jpg}
			\end{figure}
		\end{column}
	\begin{column}{.3\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.27\textheight]{img/Monazite.jpg}
		\end{figure}
	\end{column}
	\begin{column}{.3\textwidth}
	\begin{figure}
		\adjincludegraphics[height=.27\textheight]{img/Monazite_sand.png}
	\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Bastnaesit_Burundi.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Bastnasite-122211.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.5\textwidth]{img/Rareearthoxides.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item $^{147}$Pm se získává štěpením $^{235}$U a $^{239}$Pu v reaktoru.\footnote[frame]{HÁLA, Jiří. \textit{Radioaktivní izotopy}. Tišnov: Sursum, 2013. ISBN 978-80-7323-248-1.}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
		\begin{figure}
		\adjincludegraphics[height=0.75\textheight]{img/Decay_Chain_Thorium.png}
		\caption*{Thoriová rozpadová řada}
	\end{figure}
		\end{column}

	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.75\textheight]{img/Decay_Chain_Neptunium.png}
			\caption*{Neptuniová rozpadová řada}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.75\textheight]{img/Decay_Chain_Uranium.png}
				\caption*{Uranová rozpadová řada}
			\end{figure}
		\end{column}

		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.75\textheight]{img/Decay_Chain_Actinium.png}
				\caption*{Aktiniová rozpadová řada}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Světová produkce uranu v roce 2015}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Uranový důl v Dolní Rožínce}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.25\textheight]{img/OPOBu.png}
	\end{figure}
		\end{column}
	\begin{column}{.4\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.6\textheight]{img/Tor.jpg}
			\caption*{Thór, bůh hromu, deště, nebe a plodnosti země}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Plutonium bylo poprvé připraveno bombardováním $^{238}$U jádry deuteria v cyklotronu.
		...
		\item Izolace plutonia z vyhořelého paliva se provádí procesem PUREX.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.3\textwidth]{img/Plutonium3.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
	\begin{figure}
	\adjincludegraphics[height=.75\textheight]{img/Ybco002.png}
	\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{8 BaCO3 + 2 Y2(CO3)3 + 12 CuCO3 + 1-x O2 -> 4 YBa2Cu3O_{7-x} + 26 CO2}
		\item Výchozí látky se smísí v práškovém stavu a poté se kalcinují v atmosféře kyslíku.
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=\textwidth]{img/BaYCusuperconduct.jpg}
	\end{center}
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[height=4cm]{img/EfektMeisnera.png}
		\adjincludegraphics[height=4cm]{img/Meissner_effect.jpg}
	\end{center}
}
...
\frame{
	...
	\vfill
	\begin{center}
		\includegraphics[keepaspectratio,height=0.8\textheight]{img/Cutaway_of_NMR_magnet.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Technika využívaná ke zobrazení vnitřních orgánů.
		\item Na rozdíl od NMR neměříme posun, ale rozdílné relaxační časy vodíkových jader v organismu.
	\end{itemize}
	\begin{center}
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
		\item Aby ke slučování mohlo dojít, je nutné v místě reakce vytvořit plasma o teplotě 100 miliónů $^\circ$C.
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[height=30mm]{img/ITER_site_2018_aerial_view_(41809720041).jpg}
		\adjincludegraphics[height=30mm]{img/U.S._Department_of_Energy.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
			\includegraphics[keepaspectratio,width=0.8\textwidth]{img/Windmills_D1-D4.jpg}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.7\textwidth]{img/Mischmetal.jpg}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item Využívají se např. při konstrukci stolních NMR spektrometrů.
			\end{itemize}
		\end{column}
		\begin{column}{.35\textwidth}
			\adjincludegraphics[height=.8\textwidth,rotate=90]{img/Neodymag.jpg}
		\end{column}
	\end{columns}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/Magritek-C10.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.35\textheight]{img/Yttrium-aluminum_garnet.jpg}
		\end{figure}
		\end{column}
	\begin{column}{.4\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.35\textheight]{img/Powerlite_NdYAG.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	\frametitle{}
	\vfill
	\textbf{Jaderná energetika}
	\begin{columns}
		\begin{column}{.75\textwidth}
		\begin{itemize}
			\item S aktinoidy se setkáváme jaderné energetice a také u jaderných zbraní.
		...
		\end{column}
		\begin{column}{.35\textwidth}
			\adjincludegraphics[width=1.1\textwidth]{img/Nuclear_fission.png}
		\end{column}
	\end{columns}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item[\textbf{1905}] Speciální teorie relativity, vztah mezi hmotou a energií: $E = mc^2$
...
\frame{
	...
	\begin{column}{.4\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.7\textheight]{img/Los_Alamos_Primer_assembly_methods.png}
			\caption*{Mechanismy odpalování atomových bomb}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{^{235}_{\ 92}U + ^1_0n -> ^{236}_{\ 92}U -> ^{141}_{\ 56}Ba + ^{92}_{36}Kr + 3 ^1_0n}
		...
		\item Fluor je monoizotopický, tím se zbavíme nutnosti řešit vyšší počet izotopologů \ce{UF6}, skládá se pouze ze dvou: $^{235}$\ce{UF6} a $^{238}$\ce{UF6}.
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.65\textheight]{img/Countercurrent_Gas_Centrifuge.png}
				\caption*{Centrifuga s teplotním gradientem}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.75\textheight]{img/Gas_centrifuge_cascade.jpg}
		\caption*{Soustava plynových centrifug}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.5\textheight]{img/Gaseous_Diffusion.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.5\textheight]{img/Calutron.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.55\textheight]{img/Fission_bomb_assembly_methods.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/Trinity_shot_color.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		\item První vojenské použití atomových zbraní bylo na konci 2.~světové války.
		...
		\item 9. srpna 1945 byla svržena plutoniová jaderná bomba \textit{Fat Boy} na japonské město Nagasaki.
	\end{itemize}
	\begin{columns}
	\begin{column}{.5\textwidth}
		\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/Little_boy.jpg}
		\caption*{Little Boy}
	\end{figure}
	\end{column}
	\begin{column}{.5\textwidth}
	\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/Fat_man.jpg}
		\caption*{Fat man}
	\end{figure}
\end{column}
	\end{columns}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.75\textheight]{img/Nagasaki_1945_-_Before_and_after.jpg}
		\caption*{Nagasaki před a po bombardování}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\begin{itemize}
				...
				\item Bombardování vedlo ke kapitulaci Japonska.
				\item USA měly připravené další čtyři jaderné bomby, které už ale nebyly použity.
			\end{itemize}
		\begin{figure}
			\adjincludegraphics[height=0.35\textheight]{img/Hiroshima-pref-prom-hall-04.jpg}
		\end{figure}
		\end{column}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.65\textheight]{img/Atomic_cloud_over_Hiroshima.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Jako palivo se zpravidla využívá obohacený uran, který obsahuje \mbox{2--5~\%} izotopu $^{235}$U.
		...
		\item Podstatně více uranu je uloženo v mořské vodě, odhaduje se až $10^{10}$ tun, ale koncentrace je velmi nízká, zhruba $10^{-7}$--$10^{-9}$~g.dm$^{-3}$.\footnote[frame]{\href{https://www.pnnl.gov/news/release.aspx?id=4514}{Seawater yields first grams of yellowcake}}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/Nuclear_power_plant-pressurized_water_reactor-PWR.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/Nuclear.power.plant.Dukovany.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/JETE3.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Struktura komplexu uranu v extraktu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		\item Přídavkem dusitanu dojde k oxidaci neptunia na \ce{NpO$_2^{2+}$} a všechny tři ionty jsou extrahovány pomocí roztoku tributylfosfátu v kerosinu.
		\item Extrakt obsahuje pouze ionty uranu, neptunia a plutonia. Železnatou solí se zredukuje plutonium a neptunium na \ce{Pu^{3+}} a \ce{Np^{4+}}. V tomto kroku dojde k přechodu plutonité soli do vodného prostředí a plutonium je dále zpracováváno, zatímco uran a neptunium zůstávají v organické fázi.
		...
		\item Lze jej použít i k přípravě tzv. \textit{MOX paliva} (Mixed OXide fuel: \ce{PuO2} a \ce{UO2}), které je dnes už možné využívat v reaktorech. Tím se separace zjednoduší.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{tabular}
	\caption*{Významné separační technologie}
	\end{table}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Zastoupení prvků v extraktu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.8\textheight]{img/Uranium_Reprocessing.jpg}
		\caption*{Schéma procesu PUREX}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		\item Přírodní jaderný reaktor v Oklo, ve státě Gabon na západním pobřeží Afriky.\footnote[frame]{\href{https://www.youtube.com/watch?v=cgLT1zxOIzs}{2 miliardy let starý jaderný reaktor}}
		\item Reaktor byl objeven analýzou izotopického složení uranových rud.\footnote[frame]{\href{http://webmineral.com/data/Thortveitite.shtml}{Meet Oklo, the Earth’s Two-billion-year-old only Known Natural Nuclear Reactor}}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.7\textheight]{img/Gabon_Geology_Oklo.png}
		\caption*{Schéma přírodního reaktoru v Oklo. 1 - jaderný reaktor; 2 - pískovec; 3 - uranová ruda; 4 - žula}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Dnes už jaderná reakce v oblasti neprobíhá a ani nelze očekávat, že by došlo k dalšímu samovolnému spuštění. Důvodem je snížení koncentrace $^{235}$U radioaktivním rozpadem.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Reakcí lanthanoidů s vodíkem za teploty nad 300~$^\circ$C vznikají černé hydridy \ce{LnH2}.
		\item Mají fluoritovou strukturu a kubickou, plošně centrovanou mřížku.
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
		\begin{figure}
		\adjincludegraphics[height=0.4\textheight]{img/Calcium-fluoride-3D-ionic.png}
		\end{figure}
		\end{column}
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.4\textheight]{img/CaF2_polyhedra.png}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Diamond_Anvil_Cell_-_Cross_Section.png}
		\caption*{Řez diamantovou kovadlinou}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.35\textwidth}
			\begin{figure}
				...
				\caption*{Oktaedr doplněný o jeden vrchol}
			\end{figure}
		\end{column}
		...
		\begin{column}{.35\textwidth}
			\begin{figure}
				...
				\caption*{Trigonální prisma doplněné o jeden vrchol}
			\end{figure}
		\end{column}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.6\textwidth]{img/Kristallstruktur_Triuranoctoxid.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.37\textheight]{img/Studtite-Uranophane-214952.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.37\textheight]{img/LaF3_structure.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Tetrafluoridy jsou známé až po \ce{CfF4}, jsou nerozpustné ve vodě.
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Dusičnany \ce{Ln(NO3)3}: La, Ce, Pr, Nd, Sm, Eu, Gd, Tb, Dy, Ho, Er, Tm, Yb, Lu.}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{column}{.5\textwidth}
		\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/Uranocene-3D-vdW.png}
		\caption*{Kalotový model uranocenu}
	\end{figure}
	\end{column}
	\end{columns}
	\vfill
